...
async def crisis_command(update: Update, context: ContextTypes.DEFAULT_TYPE) -> None:
    ...
    crisis_message = (
        ...
        "🚨 **Đường dây sống sót quốc gia: 988**\n"
        "(Gọi hoặc nhắn tin, có sẵn 24/7)\n\n"
        "💬 **Đường dây khủng hoảng: Gửi HOME đến 741741**\n"
        "(Miễn phí, bảo mật, có sẵn 24/7)\n\n"
        "📞 **Đường dây SAMHSA quốc gia: 1-800-662-4357**\n"
        "(Miễn phí, bảo mật, 24 giờ mỗi ngày)\n\n"
        "🏥 **Nếu gặp nguy hiểm tức thì:** Gọi 911 hoặc đi đến phòng khám gần nhất.\n\n"
